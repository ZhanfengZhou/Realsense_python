...
Trans_camera2end = np.loadtxt("3D_reconstruction_images/hand_eye_calibration_matrix_new.txt")
...
for i in range(ur5_pose_euler_angle.shape[0]):
    ...
    np.savetxt(f'3D_reconstruction_images/Matrix_camera2base/camera2base_matrix_for_image_new{i}.txt', Trans_camera2base[i])
